...
public interface StudentCourseMapper {
    @Insert("insert into student.student_course(name,no,student_id,course_id) values (#{name},#{no},#{studentId},#{courseId})")
    ...
    @Select("select * from student.student_course where name like concat('%',#{name},'%') and no like concat('%',#{no},'%')")
